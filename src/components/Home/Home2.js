          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" data-aos="fade-up">
              ...
              I'm a <i className="primary-header">
               Software Engineer focused on crafting clean & user‑friendly experiences
              </i>{" "}
              who loves solving problems and building Websites.
              <br />
              <br />I am passionate about{" "}
              <i className="primary-header">building</i> excellent software that improves the lives of those around me
              <br />
              ...
              <i className="primary-header">PHP & Javascript</i> and Framework like
              <i className="primary-header"> Laravel, React.js, Vue.JS.</i>
              <br />
              <br />
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links" data-aos="fade-up">
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/mehedi_dnt_fci"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="twitter"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/mh-shuvo/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="linkedin"
